...
NOTARIZE_BUNDLE_ID=com.CustomButtPlugs.SubPlug
NOTARIZE_BUNDLE_ID_DEMO=com.CustomButtPlugs.SubPlug.DEMO
...
#if [ $DEMO == 1 ]
#then
#  git checkout installer/SubPlug.iss
#  git checkout installer/SubPlug.pkgproj
