...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=SubPlug Demo Installer\n"
      else:
        line="OutputBaseFilename=SubPlug Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the SubPlug Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the SubPlug installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=SubPlug Demo installer\n"
     else:
       line="SetupWindowTitle=SubPlug installer\n"
